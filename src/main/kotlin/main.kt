...
suspend fun main() {
    ...
    val episodesNotYetDownloaded = episodes.filter { !it.flashCardsDownloaded }
...
//        .header("Cookie", "PHPSESSID=7n7d9fjgi2rk0fhmh4fdjq0i0l")
        .url("https://nsi-flashcards.newsinslowitalian.com/episode${episode.episodeNumber}_flashcard.pdf")
        .build()
...
fun createMp3File(episode: Episode, byteStream: InputStream) {
    val file = File("episodes/flashcards/${episode.episodeNumber}-${episode.year}.pdf")
    file.createNewFile()
